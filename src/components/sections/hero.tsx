          ...
          {!isLoading && (
            <>
              <div >
                ...
                <BlurIn delay={1}>
                  <Tooltip delayDuration={300}>
                    ...
                    >
                      theres something waiting for you in development
                    </TooltipContent>
                  </Tooltip>
                </BlurIn>
                ...
                <BlurIn delay={1.2}>
                  <p
                    className={cn(
                      "md:self-start md:mt-4 font-thin text-lg text-slate-500 dark:text-zinc-400 ml-3 px-4 md:px-0",
              ...
              <div className="mt-8 md:ml-2 flex flex-col gap-3">
                <Link
                  href={
                    "https://drive.google.com/file/d/1XVUhVYB-nFqcrk8iZcwRil8fwGxUHtAA/view?usp=drive_link"
                  }
                  target="_blank"
                  className="flex-1"
                >
