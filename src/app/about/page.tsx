...
const CONTACT_LINKS = [
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/shubham-rakheja",
    content: "/shubham-rakheja",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Shubham Rakheja</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Shubham Rakheja, a Comp. Sci. Engineer with 1 year
              experience in Devlopment with hands-on experience in deploying &
              automating workflows, and collaborating with foreign clients.
              Strong analytical skills,effective communication, and a
              team-oriented approach to driving process improvements and
              delivering results.
            </p>
            <p className="mb-10">
              When I&apos;m not coding, you can find me playing Cricket and Chess, exploring new technologies, or sipping coffee
